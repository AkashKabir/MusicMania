...
import com.akitsme.musicmania.Fragments.Album_fragment;
...
import com.akitsme.musicmania.Fragments.TopSongs_fragment;
...
public class CustompagerAdapter extends FragmentPagerAdapter {
    ...
    public Fragment getItem(int position) {
        switch(position){
            case 0: return new TopSongs_fragment();
            case 1: return new Artist_fragment();
            case 2: return new Album_fragment();
